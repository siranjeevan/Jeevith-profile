...
const MovingBackground = () => {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      {/* Gradient background with #baa794 theme */}
      <div className="absolute inset-0 bg-gradient-to-br from-white via-[#baa794]/10 to-[#8b7355]/20"></div>
      
      {/* Different animated particles with #baa794 color scheme */}
      {[...Array(12)].map((_, i) => (
        <div
          key={i}
      ...
      {/* Large moving elements with gradient combinations */}
      ...
      {/* Mixed animated shapes with new color scheme */}
